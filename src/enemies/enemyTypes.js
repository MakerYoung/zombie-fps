...
export const ENEMY_ORDER = ['assault','shooter','heavy','rocketeer','exploder','sniper','boss'];
export const unlockWave = type => ({ assault:1, shooter:3, heavy:4, rocketeer:5, exploder:6, sniper:8, boss:5 }[type] ?? 99);
